...
export default function Process() {
  return (
    <section id="procesas" className="section-py bg-brand-800">
      <div className="wrapper">
        {/* Header */}
        <div className="max-w-2xl mb-16">
          <p className="font-sans text-xs font-semibold tracking-[0.2em] uppercase text-gold-400 mb-4">
            Kaip dirbame
          </p>
        ...
        {/* Steps – horizontal line on desktop */}
        <div className="relative">
          {/* Connecting line (desktop only) */}
          <div
            className="hidden lg:block absolute top-10 left-0 right-0 h-px bg-white/10"
            aria-hidden="true"
          />
            ...
            {steps.map((step, i) => (
              <div key={step.number} className="relative">
                ...
                <div className="flex items-center gap-4 mb-5 lg:flex-col lg:items-start lg:gap-0">
                  <div className="relative z-10 flex-shrink-0 w-20 h-20 bg-brand-900 border border-white/10 flex items-center justify-center lg:mb-6">
                    <span className="font-garamond text-gold-400 text-3xl font-normal">
                      {step.number}
                    </span>
                  </div>
                </div>

                <h3 className="font-garamond text-xl md:text-2xl text-white mb-3">
                  {step.title}
                </h3>
        ...
        <div className="mt-16 pt-10 border-t border-white/10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
          <p className="font-garamond text-white text-xl md:text-2xl max-w-sm leading-snug">
